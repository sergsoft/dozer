 ...
 */
public abstract class AbstractBeanMappingBuilder<T extends TypeMappingBuilder> {

  private DozerBuilder dozerBuilder;

  public AbstractBeanMappingBuilder() {
  }
  ...
  public T mapping(String typeA, String typeB, TypeMappingOption ... typeMappingOption) {
    return mapping(new TypeDefinition(typeA), new TypeDefinition(typeB), typeMappingOption);
  }

  public T mapping(TypeDefinition typeA, String typeB, TypeMappingOption ... typeMappingOption) {
    return mapping(typeA, new TypeDefinition(typeB), typeMappingOption);
  }

  public T mapping(String typeA, TypeDefinition typeB, TypeMappingOption ... typeMappingOption) {
    return mapping(new TypeDefinition(typeA), typeB, typeMappingOption);
  }

  public T mapping(Class<?> typeA, Class<?> typeB, TypeMappingOption ... typeMappingOption) {
    return mapping(new TypeDefinition(typeA), new TypeDefinition(typeB), typeMappingOption);
  }

  public T mapping(TypeDefinition typeA, Class<?> typeB, TypeMappingOption ... typeMappingOption) {
    return mapping(typeA, new TypeDefinition(typeB), typeMappingOption);
  }

  public T mapping(Class<?> typeA, TypeDefinition typeB, TypeMappingOption ... typeMappingOption) {
    return mapping(new TypeDefinition(typeA), typeB, typeMappingOption);
  }

  public T mapping(TypeDefinition typeA, TypeDefinition typeB, TypeMappingOption ... typeMappingOption) {
    ...
    return makeTypeMappingBuilder(mappingBuilder);
  }

  protected abstract T makeTypeMappingBuilder(DozerBuilder.MappingBuilder mappingBuilder);
